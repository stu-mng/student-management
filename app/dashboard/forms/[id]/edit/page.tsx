...
export default function FormEditPage() {
  ...
  // 檢查用戶權限
  const hasEditPermission = user && user.role && ['admin', 'root', 'manager'].includes(user.role)
  ...
  useEffect(() => {
    ...
    loadForm()
  }, [formId, hasEditPermission, router])
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">編輯表單</h1>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">編輯表單</h1>
            <p className="text-muted-foreground mt-2">編輯現有表單</p>
          </div>
        </div>
