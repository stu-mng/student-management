...
export function FieldValidationEditor({ field, onUpdate }: FieldValidationEditorProps) {
  ...
  if (field.field_type === 'file_upload') {
    ...
    const fileTypeOptions = [
      ...
      { value: '.jpg', label: 'JPEG 圖片 (.jpg)' },
      { value: '.jpeg', label: 'JPEG 圖片 (.jpeg)' },
      { value: '.png', label: 'PNG 圖片 (.png)' },
      { value: '.gif', label: 'GIF 圖片 (.gif)' },
      { value: '.svg', label: 'SVG 圖片 (.svg)' },
      { value: '.bmp', label: 'BMP 圖片 (.bmp)' },
      { value: '.webp', label: 'WebP 圖片 (.webp)' },
      { value: '.xls', label: 'Excel 文件 (.xls)' },
      { value: '.xlsx', label: 'Excel 文件 (.xlsx)' },
      { value: '.ppt', label: 'PowerPoint (.ppt)' },
      { value: '.pptx', label: 'PowerPoint (.pptx)' },
      { value: '.txt', label: '純文字檔案 (.txt)' },
      { value: '.rtf', label: 'RTF 文件 (.rtf)' },
      { value: '.zip', label: 'ZIP 壓縮檔 (.zip)' },
      { value: '.rar', label: 'RAR 壓縮檔 (.rar)' },
      { value: '.7z', label: '7z 壓縮檔 (.7z)' },
      { value: '.mp4', label: 'MP4 影片 (.mp4)' },
      { value: '.avi', label: 'AVI 影片 (.avi)' },
      { value: '.mov', label: 'MOV 影片 (.mov)' },
      { value: '.wmv', label: 'WMV 影片 (.wmv)' },
      { value: '.mp3', label: 'MP3 音檔 (.mp3)' },
      { value: '.wav', label: 'WAV 音檔 (.wav)' },
      { value: '.flac', label: 'FLAC 音檔 (.flac)' },
    ]
